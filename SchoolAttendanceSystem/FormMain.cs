...
namespace SchoolAttendanceSystem
{
    public partial class FormMain : Form
    {
        ...
        {
            FormTeacherList.Instance.MdiParent = this;
            FormTeacherList.Instance.Show();
            FormTeacherList.Instance.BringToFront();
            FormTeacherList.Instance.Activate();
            FormTeacherList.Instance.WindowState = FormWindowState.Normal;
            FormTeacherList.Instance.Focus();
        }
